...
interface AccountListProps {
  ...
  onSignIn?: (site: DisplaySiteData) => Promise<void>
...
export default function AccountList({
  ...
  const handleSignIn = async (site: DisplaySiteData) => {
    if (onSignIn) {
      try {
        await onSignIn(site)
      } catch (error) {
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 flex-1 min-w-0">
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-gray-500 truncate ml-4 flex items-center space-x-1">
              ...
              <div className="flex items-center space-x-2 flex-shrink-0">
                ...
                <Menu as="div" className="relative">
                  ...
                  <MenuItems
                    ...
                    <MenuItem disabled={site.signedToday}>
                      <button
                        onClick={() => onSignIn?.(site)}
                        ...
                        <span>{site.signedToday ? "已签到" : "签到"}</span>
                      </button>
                    </MenuItem>
                    <MenuItem>
                      <button
