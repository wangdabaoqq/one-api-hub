...
const DEFAULT_PREFERENCES: UserPreferences = {
  ...
  autoSignInOnOpen: true, // 默认打开插件时自动签到
...
class UserPreferencesService {
  ...
  async updateAutoSignInOnOpen(autoSignInOnOpen: boolean): Promise<boolean> {
    return this.savePreferences({ autoSignInOnOpen })
  }
